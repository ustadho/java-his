...
angular.module('template/customTimepicker/timepicker.html', []).run(['$templateCache',
  function($templateCache) {
    $templateCache.put('template/customTimepicker/timepicker.html',
      '<table>\n' +
      '	<tbody>\n' +
...
angular.module('template/customTimepicker/popup.html', []).run(['$templateCache',
  function($templateCache) {
    $templateCache.put('template/customTimepicker/popup.html',
